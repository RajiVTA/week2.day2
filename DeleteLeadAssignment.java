...
public class DeleteLeadAssignment {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//WebElement firstResult = driver.findElement(By.xpath("//a[@id='ext-gen843']"));
		...
		//WebElement firstResult = driver.findElement(By.xpath("//td[@class='x-grid3-col x-grid3-cell x-grid3-td-partyId x-grid3-cell-first ']//div[@class='x-grid3-cell-inner x-grid3-col-partyId']"));
		//WebElement firstResult = driver.findElement(By.xpath("//td[@class='x-grid3-col x-grid3-cell x-grid3-td-partyId x-grid3-cell-first ']//a[@id='ext-gen847']"));
		//WebElement firstResult = driver.findElement(By.xpath("//table[@class='x-grid3-row-table']//a"));
		
		//WebElement firstResult = driver.findElement(By.xpath("//table[@class='x-grid3-row-table']//a[text()='10162']"));
		
		//WebElement firstResult = driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a[@id='ext-gen846']"));
		//WebElement firstResult = driver.findElement(By.xpath("//table[@class='x-grid3-row-table']/tbody/tr[1]/td[1]"));
